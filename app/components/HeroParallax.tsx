...
export const HeroParallax = ({
  ...
  return (
    <div
      ref={ref}
      className="bg-black/95 h-[260vh] md:h-[420vh] xl:h-[360vh] py-40 overflow-hidden  antialiased relative flex flex-col self-auto [perspective:1000px] [transform-style:preserve-3d]"
    >
      <Header />
      <motion.div
        style={{
