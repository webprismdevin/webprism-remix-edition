...
export const HeroParallax = ({
  ...
  return (
    <div
      ref={ref}
      className="bg-black/95 h-[260vh] md:h-[420vh] xl:h-[345vh] py-40 overflow-hidden  antialiased relative flex flex-col self-auto [perspective:1000px] [transform-style:preserve-3d]"
    >
      <Header />
      <motion.div
        style={{
...
export const ProductCard = ({
  ...
  if (!product.link || !product.thumbnail) return null;
  ...
  return (
    <motion.div
      ...
      key={product.title}
      className="group/product h-[12rem] w-[20rem] md:h-[36rem] md:w-[58rem] relative flex-shrink-0"
    >
